...
public class Calculadora extends JFrame {
	...
	public Calculadora() {
		...
		lblNewLabel.setBounds(26, 22, 81, 14);
		contentPane.add(lblNewLabel);
		
		tfNum1 = new JTextField();
		tfNum1.setFont(new Font("Arial", Font.PLAIN, 14));
		tfNum1.setBounds(117, 19, 86, 20);
		contentPane.add(tfNum1);
		tfNum1.setColumns(10);
		
		JLabel lblNewLabel_1 = new JLabel("Numero 2:");
		lblNewLabel_1.setFont(new Font("Arial", Font.PLAIN, 14));
		lblNewLabel_1.setBounds(26, 66, 81, 14);
		contentPane.add(lblNewLabel_1);
		
		tfNum2 = new JTextField();
		tfNum2.setFont(new Font("Arial", Font.PLAIN, 14));
		tfNum2.setBounds(117, 64, 86, 20);
		contentPane.add(tfNum2);
		tfNum2.setColumns(10);
		
		JLabel lblNewLabel_2 = new JLabel("Resultado:");
		lblNewLabel_2.setFont(new Font("Arial", Font.PLAIN, 14));
		lblNewLabel_2.setBounds(26, 179, 81, 14);
		contentPane.add(lblNewLabel_2);
		
		tfResultado = new JTextField();
		tfResultado.setFont(new Font("Arial", Font.PLAIN, 14));
		tfResultado.setBounds(117, 177, 309, 42);
		...
		btnNewButton.setBounds(184, 107, 116, 23);
		...
		btnNewButton_1.setBounds(310, 107, 116, 23);
		...
		btnNewButton_2.setBounds(184, 141, 116, 23);
		...
		btnNewButton_3.setBounds(320, 142, 106, 23);
